  ...
  return (
    <div className="profile-container">
      <div className="page-hero w-full">
        <img
          src={placeholderBanner(`profile-${currentUser.$id}`)}
          alt=""
          className="h-full w-full object-cover"
        />
        <div className="absolute inset-0 bg-gradient-to-t from-dark-1/95 via-dark-1/40 to-transparent" />
      </div>
      <div className="profile-inner_container">
        <div className="flex max-xl:items-center xl:flex-row flex-1 flex-col gap-7">
          <img
            src={profileSrc}
            alt=""
            className="h-28 w-28 rounded-full object-cover ring-4 ring-dark-4 lg:h-36 lg:w-36"
          />
          <div className="flex flex-col flex-1 justify-between md:mt-2">
            ...
            <p className="small-medium md:base-medium text-center xl:text-left mt-7 max-w-screen-sm">
              {pickUserBio(currentUser as unknown as Record<string, unknown>)}
            </p>
          </div>
